                                ...
                                <tbody>
                                    ...
                                    @foreach ($bab4 as $bab_4)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('opd.bab4.show', $bab_4->id) }}" class="btn btn-info"
                                                    data-id="{{ $bab_4->id }}"><i class="fa fa-eye"></i> Show</a>
                                                <a href="{{ route('opd.bab4.edit', $bab_4->id) }}"
                                                    class="btn btn-warning mx-2">Edit <i class="fas fa-edit"></i></a>
                                                <form action="{{ route('opd.bab4.destroy', $bab_4->id) }}" method="POST"
