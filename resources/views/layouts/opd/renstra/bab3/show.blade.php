    ...
    <div class="row">
        <div class="col-12">
            <div class="card-body">
                ...
                <a href="{{ route('opd.bab3.exportPdf', $bab3->id) }} "target="_blank">
                ...
                <div class="document-content">
                    ...
                    @php
                            ...
                            <p class="indent">Dalam menentukan masalah pokok, masalah, dan akar masalah perlu disusun analisis pohon masalah sebagai bagain dari penentuan permasalahan yang riel dihadapai Perangkat Daerah dalam penyelanggaraan urusan pemerintahan. 
                                Sebagaimana analisi pohon masalah dapat disimpulkan permasalahan pada <span style="color: rgb(11, 242, 11);">{{ $selectedOpd['nama_opd'] ?? 'N/A' }}</span> adalah sebagai berikut: </p>
                        </ol>
                    ...
                    <p class="indent">Identifikasi hasil reviu faktor-faktor pelayanan perangkat daerah 
                        ...
                        <ol>
                            <li>Gambaran pelayanan perangkat daerah <pre style="color: rgb(244, 11, 11);">{!! $bab3->uraian1 !!}</pre> </li>
                            <li>Sasaran jangka menengah pada renstra Kementerian/Lembaga <pre style="color: rgb(244, 11, 11);">{!! $bab3->uraian2 !!}</pre></li>
                            <li>Sasaran jangka menengah dari renstra Perangkat Daerah provinsi <pre style="color: rgb(244, 11, 11);">{!! $bab3->uraian3 !!}</pre></li>
