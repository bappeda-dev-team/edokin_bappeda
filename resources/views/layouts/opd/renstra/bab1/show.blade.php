        ...
        <div class="row">
            <div class="col-12">
                <div class="card-body">
                    ...
                    <a href="{{ route('opd.bab1.exportPdf', $bab1->id) }} "target="_blank">
                        <button class="btn btn-danger mb-3"><i class="fa fa-file-pdf"></i> Export to PDF </button>
                    </a>
                    <a href="{{ route('opd.bab1.exportWord', $bab1->id) }}">
                    ...
                    <div class="document-content">
                        ...
                        <p class="indent">Rencana Strategis Perangkat Daerah (Renstra PD) merupakan dokumen perencanaan yang
                            dibuat setiap 5 (lima) tahun sebagai tindaklanjut telah ditetapkannya dokumen
                            Rencana Pembangunan Daerah (RPD) atau Rencana Pembangunan Jangka Menengah Daerah (RPJMD).
                            Penyusunan Renstra PD tidak lepas dari peran stakeholder serta
                            Masyarakat. Tahapan penyusunan Renstra PD tertuang dalam pasal 108 sampai dengan pasal 124
                            Peraturan Menteri Dalam Negeri Nomor 86 Tahun 2017, dimulai dari tahapan:</p>
                        <div class="list">
                            <ol style="list-style-type: lower-alpha">
                                <li>
                                    persiapan penyusunan renstra:
                                    <ul>
                                        <li>Menyusun rancangan keputusan Kepala Daerah tentang pembentukan tim penyusun
                                            Renstra Perangkat Daerah</li>
                                        <li>Orientasi mengenai Renstra Perangkat Daerah</li>
                                        <li>Penyusunan agenda kerja tim penyusun Renstra Perangkat Daerah</li>
                                        <li>Penyiapan data dan informasi perencanaan pembangunan Daerah berdasarkan SIPD
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <ol style="list-style-type: lower-alpha">
                                            ...
                                            <li>merumusan tujuan dan sasaran Perangkat Daerah berdasarkan sasaran dan
                                                indikator serta target kinerja dalam rancangan RPJMD/RPD</li>
                                            <li>merumuskan strategi dan arah kebijakan Perangkat Daerah untuk mencapai
                                                tujuan dan sasaran serta target kinerja Perangkat Daerah</li>
                                            <li>merumuskan rencana program, kegiatan, indikator kinerja, pagu indikatif,
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>Untuk penyempurnaan menunggu Surat Edaran Kepala Daerah tentang penyusunan
                                            rancangan Renstra Perangkat Daerah kepada Kepala Perangkat Daerah dengan
                                            lampiran rancangan awal RPJMD/RPD</li>
                                        <li>Rancangan awal Renstra untuk menjadi rancangan Renstra harus disempurnakan
                                            dengan berdasarkan hasil pelaksanaan Forum Renstra Perangkat Daerah yang
                                            dirumuskan dalam berita acara</li>
                                        <li>Penyampaian rancangan Renstra paling lambat 10 (sepuluh) hari setelah
                                            pelaksanaan forum perangkat daerah untuk dilakukan verifikasi oleh Bappeda.</li>
                                        <li>Verifikasi rancangan renstra perangkat daerah disampaikan paling lambat 2 (dua)
                                            minggu setelah penyampaian perangkat daerah kepada Bappeda. </li>
                                    </ul>
                                </li>
                                <li>
                                    pelaksanaan forum perangkat daerah/ lintas perangkat daerah;
                                    <ul>
                                        <li>dilaksanakan paling lambat 2 minggu setelah Surat Edaran Penyempurnaan Rancangan
                                            Renstra Perangkat Daerah </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    penetapan
                                    <ul>
                                        <li>ditetapkan paling lambat 1 (satu) minggu setelah Peraturan Kepala Daerah tentang
                                ...
                                <p>
                                    ...
                                    Kota Madiun mengelola urusan dan bidang urusan sebagai berikut :
                                </p>
                            </ol>
                            {{-- <ol>
                            ...
                            <ol>
                                @if (isset($selectedOpd['urusan_opd']) && is_array($selectedOpd['urusan_opd']) && count($selectedOpd['urusan_opd']) > 0)
                                    @foreach ($selectedOpd['urusan_opd'] as $urusan)
                                        @if (isset($urusan['bidang_urusan_opd']) &&
                            ...
                            <p class="indent">Rencana Strategis Perangkat Daerah Tahun 2024-2026 yang disusun telah selaras
                                ...
                                selama 2 (dua) tahun yang telah disusun melalui
                                berbagai tahapan dan telah melibatkan unsur masyarakat dan stakeholder, Renstra PD yang
                                disusun juga telah mengakomodir dokumen perencanaan Kementerian/Lembaga sebagai bagian dari
                                kewenangan
                                serta tugas dan pokok dan fungsi serta kewenangan Perangkat Daerah. Renstra PD akan menjadi
                                dasar acuan penyusunan rencana kerja tahunan Perangkat Daerah.</p>
                            <br>
                            ...
                            <ol>
                                <li>Memberikan gambaran kinerja Perangkat Daerah pada renstra tahun sebelumnya yaitu renstra
                                    tahun 2019-2024;</li>
                                <li>Memberikan gambaran rencana strategis Perangkat Daerah pada Tahun 2025-2026;</li>
                                <li>sebagai pedoman Perangkat Daerah dalam menyusun kebijakan program, kegiatan, sub
                                    kegiatan serta tolok ukur dari kinerja penyelenggaraan pemerintahan daerah selama tahun
                                    2025-2026.</li>
                            </ol>
                            <p class="indent">Tujuan disusunnya Rencana Kerja Perangkat Daerah adalah </p>
                            <ol>
                                <li>sebagai acuan pelaksanaan program, kegiatan dan sub kegiatan, serta sebagai pedoman
                                    penyusunan Rencana Kerja (Renja) Perangkat Daerah yang mengedepankan pelaksanaan
                                    akuntabilitas kinerja dalam mencapai tujuan pembangunan.</li>
                                <li>Tersedianya dokumen perencanaan tahunan yang disusun sebagai dasar Perengkat Daerah
                                    menyusun Renja Perangkat Daerah pada Tahun 2025 dan Tahun 2026.</li>
                            </ol>
                            <h4>1.4. Sistematika Penulisan</h4>
                            <p class="indent">Dengan berpedoman pada Peraturan Menteri Dalam Negeri Republik Indonesia Nomor
                                86 Tahun 2017 sistematika penyusunan Rencana Strategis Perangkat Daerah (Renstra PD) sebagai
                                berikut :</p>
                            ...
                            <li class="indent1" style=" list-style-type: none;">&emsp;2.1. Tugas, Fungsi, dan Struktur
                                Perangkat Daerah</li>
                            <li class="indent1" style=" list-style-type: none;">&emsp;2.2. Sumber Daya Perangkat Daerah</li>
                            <li class="indent1" style=" list-style-type: none;">&emsp;2.3. Kinerja Pelayanan Perangkat
                                Daerah</li>
                            ...
                            <li class="indent1" style=" list-style-type: none;">&emsp;3.1. Permasalahan Pelayanan Perangkat
                                Daerah</li>
                            ...
                            <li class="indent1" style=" list-style-type: none;">&emsp;4.1. Tujuan dan Sasaran Renstra PD
                                Tahun 2025-2026</li>
                            ...
                            <li class="indent1" style=" list-style-type: none;">&emsp;7.1. Penentuan target keberhasilan
                                pencapaian tujuan dan sasaran Renstra PD Tahun 2025-2026 melalui Indikator Kinerja Utama
                                (IKU) PD</li>
                            <li class="indent1" style=" list-style-type: none;">&emsp;7.2. Penentuan target kinerja
                                penyelenggaraan urusan pemerintahan daerah Tahun 2025-2026 melalui Indikator Kinerja Kunci
                                (IKK) PD</li>
