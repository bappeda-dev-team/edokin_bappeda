                                ...
                                <tbody>
                                    ...
                                    @foreach ($bab1 as $bab_1)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('opd.bab1.show', $bab_1->id) }}" class="btn btn-info"
                                                    data-id="{{ $bab_1->id }}"><i class="fa fa-eye"></i> Show</a>
                                                <a href="{{ route('opd.bab1.edit', $bab_1->id) }}"
                                                    class="btn btn-warning mx-2">Edit <i class="fas fa-edit"></i></a>
                                                <form action="{{ route('opd.bab1.destroy', $bab_1->id) }}" method="POST"
