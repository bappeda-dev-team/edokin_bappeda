                                ...
                                <tbody>
                                    ...
                                    @foreach ($bab6 as $bab_6)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('opd.bab6.show', $bab_6->id) }}" class="btn btn-info"
                                                    data-id="{{ $bab_6->id }}"><i class="fa fa-eye"></i> Show</a>
                                                <a href="{{ route('opd.bab6.edit', $bab_6->id) }}"
                                                    class="btn btn-warning mx-2">Edit <i class="fas fa-edit"></i></a>
                                                <form action="{{ route('opd.bab6.destroy', $bab_6->id) }}" method="POST"
