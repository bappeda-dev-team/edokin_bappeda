        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('opd.bab2.update', $bab2->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <!-- Form Fields -->
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <input type="hidden" name="kode_opd" id="kode_opd"
                                    value="{{ old('kode_opd', $bab2->kode_opd) }}" class="form-control" required>
                                <input type="text" name="nama_opd" id="nama_opd"
                                    value="{{ old('nama_opd', $bab2->nama_opd) }}" class="form-control" readonly>
                            </div>
                        </div>
