                                ...
                                <tbody>
                                    ...
                                    @foreach ($bab2 as $bab_2)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('opd.bab2.show', $bab_2->id) }}" class="btn btn-info"
                                                    data-id="{{ $bab_2->id }}"><i class="fa fa-eye"></i> Show</a>
                                                <a href="{{ route('opd.bab2.edit', $bab_2->id) }}"
                                                    class="btn btn-warning mx-2">Edit <i class="fas fa-edit"></i></a>
                                                <form action="{{ route('opd.bab2.destroy', $bab_2->id) }}" method="POST"
