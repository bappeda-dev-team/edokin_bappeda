                                ...
                                <tbody>
                                    ...
                                    @foreach ($bab8 as $bab_8)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('opd.bab8.show', $bab_8->id) }}" class="btn btn-info"
                                                    data-id="{{ $bab_8->id }}"><i class="fa fa-eye"></i> Show</a>
                                                <a href="{{ route('opd.bab8.edit', $bab_8->id) }}"
                                                    class="btn btn-warning mx-2">Edit <i class="fas fa-edit"></i></a>
                                                <form action="{{ route('opd.bab8.destroy', $bab_8->id) }}" method="POST"
