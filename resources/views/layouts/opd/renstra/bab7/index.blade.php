                                ...
                                <tbody>
                                    ...
                                    @foreach ($bab7 as $bab_7)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('opd.bab7.show', $bab_7->id) }}" class="btn btn-info"
                                                    data-id="{{ $bab_7->id }}"><i class="fa fa-eye"></i> Show</a>
                                                <a href="{{ route('opd.bab7.edit', $bab_7->id) }}"
                                                    class="btn btn-warning mx-2">Edit <i class="fas fa-edit"></i></a>
                                                <form action="{{ route('opd.bab7.destroy', $bab_7->id) }}" method="POST"
