        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('bab8.update', $bab8->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <!-- Nama Bab Field -->
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <input type="text" id="pangkat_kepala_opd" name="pangkat_kepala_opd" class="form-control" value="{{ old('pangkat_kepala_opd', $bab8->pangkat_kepala_opd) }}">
                            </div>
                        </div>
