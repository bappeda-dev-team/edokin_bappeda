                ...
                <form action="{{ route('bab2.update', $bab2->id) }}" method="POST">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <input type="text" name="nama_bab" class="form-control" value="{{ old('nama_bab', $bab2->nama_bab) }}" required>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12 col-md-4">
                            <select name="jenis_id" class="form-control selectric" required>
                                ...
                                @foreach($jenis as $item)
                                    <option value="{{ $item->id }}" {{ $bab2->jenis_id == $item->id ? 'selected' : '' }}>{{ $item->jenis }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12 col-md-4">
                            <select name="tahun_id" class="form-control selectric" required>
                                ...
                                @foreach($tahun as $year)
                                    <option value="{{ $year->id }}" {{ $bab2->tahun_id == $year->id ? 'selected' : '' }}>{{ $year->tahun }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12 col-md-4">
                            <select name="kode_opd" id="kode_opd" class="form-control selectric" required>
                                ...
                                @foreach($urusan_opd as $opd)
                                    <option value="{{ $opd['kode_opd'] }}" {{ $bab2->kode_opd == $opd['kode_opd'] ? 'selected' : '' }}>{{ $opd['kode_opd'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <input type="text" name="nama_opd" id="nama_opd" class="form-control" value="{{ old('nama_opd', $bab2->nama_opd) }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <input type="text" name="bidang_urusan" id="bidang_urusan" class="form-control" value="{{ old('bidang_urusan', $bab2->bidang_urusan) }}" readonly>
                        </div>
                    </div>
