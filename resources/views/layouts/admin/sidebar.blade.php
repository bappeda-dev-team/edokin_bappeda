<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            <li id="menu-dashboard"><a class="nav-link" href="/dashboard"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
            <li class="dropdown" id="menu-master-data">
                ...
                <ul class="dropdown-menu">
                    <li id="menu-perangkat"><a class="nav-link" href="/dashboard/perangkat">Perangkat Daerah</a></li>
