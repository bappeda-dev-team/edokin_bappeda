                        ...
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('bab7.show', $bab_7->id) }}" class="btn btn-info" data-id="{{ $bab_7->id }}"><i class="fa fa-eye"></i> Show</a>
                                        <a href="{{ route('bab7.edit', $bab_7->id) }}" class="btn btn-warning mx-2">Edit <i class="fas fa-edit"></i></a>
                                        <form action="{{ route('bab7.destroy', $bab_7->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
